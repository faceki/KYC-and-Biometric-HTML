...
const totPathUrl = window.location.pathname;
const lastPathUrl = totPathUrl.substring(totPathUrl.lastIndexOf('/') + 1);
const lastPathUrlArr=lastPathUrl.split(".");
const pathUrl='/'+lastPathUrlArr[0];
